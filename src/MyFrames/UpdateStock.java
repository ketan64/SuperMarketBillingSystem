...
public class UpdateStock extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     String query="INSERT INTO `stock`(id,`pname`,available,`quantity`,mrp) VALUES("+jTextField1.getText()+",'"+jTextField2.getText()+"',"+jTextField3.getText()+","+jTextField4.getText()+","+jTextField5.getText()+");";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String query;
        query ="UPDATE `stock` SET `id`="+jTextField1.getText()+",`pname`='"+jTextField2.getText()+"',`available`="+jTextField3.getText()+",`pname`='"+jTextField4.getText()+"',`mrp`="+jTextField5.getText()+" WHERE `id`="+jTextField1.getText();
